...
@section('content')
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-10">
                <h1 class="page-header">فاتورة المشتريات ({{ $sale->id }})</h1>
            </div>
            <br>
            <div class="col-md-2">
                    ...
                    <div class="row">
                        <div class="col-xs-4">
                            ...
                            <p><strong>اسم المورد:-</strong>
                                {{ $sale->supplier->name }}</p>
                            <p><strong> الاجمالي: </strong>{{ $sale->priceFinal }}</p>
                            <p><strong> السعر النهائي:- </strong>{{ $sale->finalPrice }}</p>
                        ...
                        <div class="col-xs-4">
                            <p>
                                <em>التاريخ : {{  $sale->date}}</em>
                            </p>
                            <p>
                                <em>رقم
                                    الاذن:-
                                    #: {{ (!empty($sale->permission_number)) ? $sale->permission_number : '-' }}</em>
                            </p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="text-center">
                            <h1>{{ $sale->stores->name }}</h1>
                        </div>
                        </span>
                        ...
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <td class="text-center">{{ $sale->taxes }}</td>
                                <td class="text-center">{{ $sale->allMeters }}</td>
                            </tr>
                            <tr>
