                                ...
                                <select class="form-control" name="country_origin_id">
                                    ...
                                    @foreach($countries as $country)
                                        <option value="{{ $country->id }}"
                                                @if($product->country_origin_id == $country->id) selected @endif>{{ $country->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <input type='text' class="form-control" name="sizes_length" id="sizes_length"
                                               placeholder="الطول" value="{{ $product->sizes_length }}"/>
                                    </div>
                                    <div class="col-md-6">
                                        <input type='text' class="form-control" name="sizes_width" id="sizes_width"
                                               placeholder="العرض" value="{{ $product->sizes_width }}"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <select class="form-control" name="color_id">
                                    ...
                                    @foreach($colors as $color)
                                        <option value="{{ $color->id }}"
                                                @if($product->color_id == $color->id) selected @endif>{{ $color->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="plotter_id">
                                    ...
                                    @foreach($plotters as $plotter)
                                        <option value="{{ $plotter->id }}"
                                                @if($product->plotter_id == $plotter->id) selected @endif>{{ $plotter->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
