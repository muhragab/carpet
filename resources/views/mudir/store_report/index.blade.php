                        ...
                        <table id="example1" class="table table-bordered table-striped dt-responsive nowrap">
                            ...
                            @foreach($data as $storeData)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{url('report/product/main/products/'. $storeData->id)}}">
                                            {{ $storeData->mainProduct }}
                                        </a>
                                    </td>
                                    <td>
                                        <a href="{{url('report/product/purchases/'. $storeData->id)}}">
                                            {{ $storeData->purchase }}
                                        </a>
                                    </td>
                                    <td>
                                        <a href="{{url('report/product/purchases/back/'. $storeData->id)}}">
                                            {{ $storeData->purchaseBack }}
                                        </a>
                                    </td>
                                    <td>
                                        <a href="{{url('report/product/sales/'. $storeData->id)}}">
                                            {{ $storeData->sale }}
                                        </a>
                                    </td>
                                    <td>
                                        <a href="{{url('report/product/sales/back/'. $storeData->id)}}">
                                            {{ $storeData->saleBack }}
                                        </a>
                                    </td>
                                   {{-- <td>
